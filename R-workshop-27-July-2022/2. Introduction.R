  ...
  # Now let's navigate to our dataset by setting our working directory (wd). 
  # Using the menu above click on:
      # Session > Set Working Directory > To Source File Location
  # Alternatively you can type: setwd("C:/write/your/file/path/here")
